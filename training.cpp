...
int main()
{
    ...
    std::vector<std::vector<float>> w1 = make_matrix(4, 10, 0.01);
    std::vector<std::vector<float>> w2 = make_matrix(10, 1, 0.01);
    std::vector<std::vector<float>> b1 = make_matrix(1, 10, 1.00);
    std::vector<std::vector<float>> b2 = make_matrix(1, 1, 1.00);
    ...
    write_matrix_to_CSV(w1,"w1");
    write_matrix_to_CSV(w2,"w2");
    write_matrix_to_CSV(b1,"b1");
    write_matrix_to_CSV(b2,"b2");
